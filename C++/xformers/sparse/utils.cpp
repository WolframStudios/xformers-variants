...
/*
Original Python source: xformers/sparse/utils.py
# Copyright (c) Facebook, Inc. and its affiliates. All rights reserved.
#
# This source code is licensed under the BSD license found in the
# LICENSE file in the root directory of this source tree.
...
std::any _coo_to_csr(std::any m, std::any n, std::any row_indices, std::any column_indices) {
  return translation::unsupported<std::any>("Translated placeholder for xformers/sparse/utils.py::_coo_to_csr");
}

std::any _csr_to_coo(std::any m, std::any n, std::any row_offsets, std::any column_indices) {
  return translation::unsupported<std::any>("Translated placeholder for xformers/sparse/utils.py::_csr_to_coo");
}

std::any _diffsort(torch::Tensor a) {
  return translation::unsupported<std::any>("Translated placeholder for xformers/sparse/utils.py::_diffsort");
}

std::any _get_transpose_info(std::any m, std::any n, std::any row_indices, std::any row_offsets, std::any column_indices) {
  return translation::unsupported<std::any>("Translated placeholder for xformers/sparse/utils.py::_get_transpose_info");
}

std::any _transpose_with_info(std::any values, std::any _transpose_info) {
  return translation::unsupported<std::any>("Translated placeholder for xformers/sparse/utils.py::_transpose_with_info");
}

std::any _transpose(std::any m, std::any n, std::any row_indices, std::any values, std::any row_offsets, std::any column_indices) {
  return translation::unsupported<std::any>("Translated placeholder for xformers/sparse/utils.py::_transpose");
}

std::any _nonzero_mask_to_sparse_csr_indices(torch::Tensor mask, std::any device) {
  /*
  Converts dense 2d matrix to a csr sparse matrix.
  */
  return translation::unsupported<std::any>("Translated placeholder for xformers/sparse/utils.py::_nonzero_mask_to_sparse_csr_indices");
}

std::any _dense_to_sparse(std::any matrix, std::any device) {
  /*
  Converts dense 2d matrix to a csr sparse matrix.
  */
  return translation::unsupported<std::any>("Translated placeholder for xformers/sparse/utils.py::_dense_to_sparse");
}

std::any _round_nnz(torch::Tensor mask, std::any divisible_by = 4) {
  return translation::unsupported<std::any>("Translated placeholder for xformers/sparse/utils.py::_round_nnz");
}

std::any _dense3d_to_sparse(std::any matrix, std::any device) {
  return translation::unsupported<std::any>("Translated placeholder for xformers/sparse/utils.py::_dense3d_to_sparse");
}
