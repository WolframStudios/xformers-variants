...
/*
Original Python source: xformers/profiler/profiler.py
# Copyright (c) Facebook, Inc. and its affiliates. All rights reserved.
#
# This source code is licensed under the BSD license found in the
# LICENSE file in the root directory of this source tree.
...
class NsightProfiler {
 public:
  ...
  capturing is performed by this profiler during certain steps.
  */
  NsightProfiler() = default;
  void __init__('_Profiler' main_profiler) {
    translation::unsupported_void("Translated placeholder for xformers/profiler/profiler.py::__init__");
  }
  void __enter__() {
    translation::unsupported_void("Translated placeholder for xformers/profiler/profiler.py::__enter__");
  }
  void __exit__(std::any exc_type, std::any exc_val, std::any exc_tb) {
    translation::unsupported_void("Translated placeholder for xformers/profiler/profiler.py::__exit__");
  }
  virtual void step() = 0;
};
...
class PyTorchProfiler {
 public:
  ...
  captures traces, memory footprint and other info that could be read via TensorBoard.
  */
  PyTorchProfiler() = default;
  void __init__('_Profiler' main_profiler) {
    translation::unsupported_void("Translated placeholder for xformers/profiler/profiler.py::__init__");
  }
  void _on_trace(torch.profiler.profiler.profile prof) {
    translation::unsupported_void("Translated placeholder for xformers/profiler/profiler.py::_on_trace");
  }
  void _preprocess_trace(torch.profiler.profiler.profile prof, std::string file_name) {
    translation::unsupported_void("Translated placeholder for xformers/profiler/profiler.py::_preprocess_trace");
  }
  void _analyze_trace(torch.profiler.profiler.profile prof) {
    translation::unsupported_void("Translated placeholder for xformers/profiler/profiler.py::_analyze_trace");
  }
  void __enter__() {
    translation::unsupported_void("Translated placeholder for xformers/profiler/profiler.py::__enter__");
  }
  ...
  void step() {
    translation::unsupported_void("Translated placeholder for xformers/profiler/profiler.py::step");
  }
};

class PyTorchProfiler_CUDAOnly : public PyTorchProfiler {
 public:
  PyTorchProfiler_CUDAOnly() = default;
  virtual void _analyze_trace(torch.profiler.profiler.profile prof) = 0;
};
...
class MemSnapshotsProfiler {
 public:
  ...
  tensors.
  */
  MemSnapshotsProfiler() = default;
  void __init__('_Profiler' main_profiler) {
    translation::unsupported_void("Translated placeholder for xformers/profiler/profiler.py::__init__");
  }
  bool _has_trace_plot() {
    return translation::unsupported<bool>("Translated placeholder for xformers/profiler/profiler.py::_has_trace_plot");
  }
  void __enter__() {
    translation::unsupported_void("Translated placeholder for xformers/profiler/profiler.py::__enter__");
  }
...
struct _ProfilerState {
 public:
  ...
  int64_t iter_end;
  std::any object;
  _ProfilerState() = default;
};

class _Profiler {
 public:
  _Profiler() = default;
  void __init__(std::string output_dir, Sequence[std::tuple<std::any, int64_t, int64_t]> schedule, std::optional<nn.Module> module) {
    translation::unsupported_void("Translated placeholder for xformers/profiler/profiler.py::__init__");
  }
  void init_schedule(int64_t offset = 0) {
    translation::unsupported_void("Translated placeholder for xformers/profiler/profiler.py::init_schedule");
  }
  void check_schedule(Sequence[std::tuple<std::any, int64_t, int64_t]> schedule) {
    translation::unsupported_void("Translated placeholder for xformers/profiler/profiler.py::check_schedule");
  }
  void update_profilers_on_step() {
    translation::unsupported_void("Translated placeholder for xformers/profiler/profiler.py::update_profilers_on_step");
  }
  Path _create_output_filename(std::string filename) {
    /*
    Returns where to write a file with desired filename.
    Handles the case where we are in distributed settings, or when
    we need to output the same file multiple times (eg if a profiler
    runs for several steps)
    */
    return translation::unsupported<Path>("Translated placeholder for xformers/profiler/profiler.py::_create_output_filename");
  }
  void start() {
    translation::unsupported_void("Translated placeholder for xformers/profiler/profiler.py::start");
  }
  void stop(std::any exc_type, std::any exc_val, std::any exc_tb) {
    translation::unsupported_void("Translated placeholder for xformers/profiler/profiler.py::stop");
  }
  std::any __enter__() {
    return translation::unsupported<std::any>("Translated placeholder for xformers/profiler/profiler.py::__enter__");
  }
  void __exit__(std::any exc_type, std::any exc_val, std::any exc_tb) {
    translation::unsupported_void("Translated placeholder for xformers/profiler/profiler.py::__exit__");
  }
  ...
  std::string format_summary() {
    return translation::unsupported<std::string>("Translated placeholder for xformers/profiler/profiler.py::format_summary");
  }
};
