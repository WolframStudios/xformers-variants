...
/*
Original Python source: xformers/_cpp_lib.py
# Copyright (c) Facebook, Inc. and its affiliates. All rights reserved.
#
# This source code is licensed under the BSD license found in the
# LICENSE file in the root directory of this source tree.
...
struct _BuildInfo {
 public:
  ...
  std::optional<int64_t> cuda_version() {
    return translation::unsupported<std::optional<int64_t>>("Translated placeholder for xformers/_cpp_lib.py::cuda_version");
  }
  std::optional<int64_t> hip_version() {
    return translation::unsupported<std::optional<int64_t>>("Translated placeholder for xformers/_cpp_lib.py::hip_version");
  }
  std::string torch_version() {
    return translation::unsupported<std::string>("Translated placeholder for xformers/_cpp_lib.py::torch_version");
  }
  std::string python_version() {
    return translation::unsupported<std::string>("Translated placeholder for xformers/_cpp_lib.py::python_version");
  }
  std::string flash_version() {
    return translation::unsupported<std::string>("Translated placeholder for xformers/_cpp_lib.py::flash_version");
  }
  bool use_torch_flash() {
    return translation::unsupported<bool>("Translated placeholder for xformers/_cpp_lib.py::use_torch_flash");
  }
  std::unordered_map<std::string, std::any> build_env() {
    return translation::unsupported<std::unordered_map<std::string, std::any>>("Translated placeholder for xformers/_cpp_lib.py::build_env");
  }
};

class xFormersWasNotBuiltException : public Exception {
 public:
  xFormersWasNotBuiltException() = default;
  std::string __str__() {
    return translation::unsupported<std::string>("Translated placeholder for xformers/_cpp_lib.py::__str__");
  }
};

class xFormersInvalidLibException : public Exception {
 public:
  xFormersInvalidLibException() = default;
  void __init__(std::optional<_BuildInfo> build_info) {
    translation::unsupported_void("Translated placeholder for xformers/_cpp_lib.py::__init__");
  }
  std::string __str__() {
    return translation::unsupported<std::string>("Translated placeholder for xformers/_cpp_lib.py::__str__");
  }
...
std::any _register_extensions() {
  return translation::unsupported<std::any>("Translated placeholder for xformers/_cpp_lib.py::_register_extensions");
}
