...
/*
Original Python source: xformers/ops/sp24.py
# Copyright (c) Facebook, Inc. and its affiliates. All rights reserved.
#
# This source code is licensed under the BSD license found in the
# LICENSE file in the root directory of this source tree.
...
class SparsifyBothWays : public BaseOperator {
 public:
  SparsifyBothWays() = default;
};

class SparsifyApply : public BaseOperator {
 public:
  SparsifyApply() = default;
};

class SparsifyApplyDenseOutput : public BaseOperator {
 public:
  SparsifyApplyDenseOutput() = default;
};

class Sp24Gemm : public BaseOperator {
 public:
  Sp24Gemm() = default;
};

std::tuple<int64_t, int64_t, int64_t> _get_cusparselt_torch_version() {
  /*
  Returns the version of the cusparselt.so library used by pytorch
  */
  return translation::unsupported<std::tuple<int64_t, int64_t, int64_t>>("Translated placeholder for xformers/ops/sp24.py::_get_cusparselt_torch_version");
}

class Sp24GemmCuspltSearch : public BaseOperator {
 public:
  Sp24GemmCuspltSearch() = default;
};

class Sp24GemmCusplt : public BaseOperator {
 public:
  Sp24GemmCusplt() = default;
};

bool _has_cusparseLt() {
  return translation::unsupported<bool>("Translated placeholder for xformers/ops/sp24.py::_has_cusparseLt");
}

std::any sparse24_pointwise_op(std::any func, std::any types, std::any args, std::any kwargs, std::any allow_sparsify_args_list) {
...
void no_dispatch() {
  translation::unsupported_void("Translated placeholder for xformers/ops/sp24.py::no_dispatch");
}

std::any fallback_dispatcher(std::any func, std::any types, std::any args, std::any kwargs) {
  return translation::unsupported<std::any>("Translated placeholder for xformers/ops/sp24.py::fallback_dispatcher");
}
...
class Sparse24Tensor : public Tensor {
 public:
  ...
  std::any __tensor_unflatten__(std::any inner_tensors, std::any flatten_spec, std::any outer_size, std::any outer_stride) {
    return translation::unsupported<std::any>("Translated placeholder for xformers/ops/sp24.py::__tensor_unflatten__");
  }
};
