...
/*
Original Python source: xformers/ops/indexing.py
# Copyright (c) Facebook, Inc. and its affiliates. All rights reserved.
#
# This source code is licensed under the BSD license found in the
# LICENSE file in the root directory of this source tree.
...
class ScaledIndexAddFw : public BaseOperator {
 public:
  ScaledIndexAddFw() = default;
};

class ScaledIndexAddBw : public BaseOperator {
 public:
  ScaledIndexAddBw() = default;
};

class IndexSelect : public BaseOperator {
 public:
  IndexSelect() = default;
};
