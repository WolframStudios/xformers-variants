...
/*
Original Python source: xformers/ops/seqpar.py
# Copyright (c) Facebook, Inc. and its affiliates. All rights reserved.
#
# This source code is licensed under the BSD license found in the
# LICENSE file in the root directory of this source tree.
...
void sequence_parallel_leading_matmul_setup_context(std::any ctx, std::any inputs, torch::Tensor output) {
  translation::unsupported_void("Translated placeholder for xformers/ops/seqpar.py::sequence_parallel_leading_matmul_setup_context");
}

std::any sequence_parallel_leading_matmul_bwd_bridge(std::any ctx, std::any grad_gathered_outputs) {
...
void sequence_parallel_trailing_matmul_setup_context(std::any ctx, std::any inputs, torch::Tensor output) {
  translation::unsupported_void("Translated placeholder for xformers/ops/seqpar.py::sequence_parallel_trailing_matmul_setup_context");
}

std::any sequence_parallel_trailing_matmul_bwd_bridge(std::any ctx, std::any grad_scattered_output) {
