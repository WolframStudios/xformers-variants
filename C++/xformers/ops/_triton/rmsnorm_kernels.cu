...
/*
Original Python source: xformers/ops/_triton/rmsnorm_kernels.py
# Copyright (c) Facebook, Inc. and its affiliates. All rights reserved.
#
# This source code is licensed under the BSD license found in the
# LICENSE file in the root directory of this source tree.
...
std::any _rms_norm_forward(torch::Tensor x, std::any attn_norm_weights, double eps) {
  return translation::unsupported<std::any>("Translated placeholder for xformers/ops/_triton/rmsnorm_kernels.py::_rms_norm_forward");
}

std::any _rms_norm_add_forward(torch::Tensor x, torch::Tensor y, std::any attn_norm_weights, double eps) {
  return translation::unsupported<std::any>("Translated placeholder for xformers/ops/_triton/rmsnorm_kernels.py::_rms_norm_add_forward");
}
