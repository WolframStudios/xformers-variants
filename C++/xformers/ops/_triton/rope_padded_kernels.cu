...
/*
Original Python source: xformers/ops/_triton/rope_padded_kernels.py
# Copyright (c) Facebook, Inc. and its affiliates. All rights reserved.
#
# This source code is licensed under the BSD license found in the
# LICENSE file in the root directory of this source tree.
...
void _rope_padded_kernel(std::any xq, std::any xk, std::any xv, std::any out_q, std::any cache_k, std::any cache_v, std::any seqstartq, std::any seqstartk, std::any seqlenk, std::any theta, std::any linear_scale, tl.constexpr use_dynamic_scaling, tl.constexpr dynamic_old_context_len, tl.constexpr dynamic_scale_factor, tl.constexpr dynamic_low_freq_factor, tl.constexpr dynamic_high_freq_factor, std::any first_seqpos, std::any seqpos, tl.constexpr k_start, tl.constexpr v_start, std::any n_groups, tl.constexpr dim, std::any stride_xqM, std::any stride_xqG, std::any stride_xqH, std::any stride_xkM, std::any stride_xkG, std::any stride_xkH, std::any stride_xvM, std::any stride_xvG, std::any stride_xvH, std::any stride_cachekM, std::any stride_cachekG, std::any stride_cachekH, std::any stride_cachevM, std::any stride_cachevG, std::any stride_cachevH, std::any stride_seqstartq, std::any stride_seqstartk, std::any stride_seqlenk, std::any stride_outqM, std::any stride_outqG, std::any stride_outqH, std::any stride_seqpos, tl.constexpr internal_dtype, tl.constexpr const_batch_strides, std::any cache_padding_length, tl.constexpr seqlenk_shift, tl.constexpr BLOCK_SIZE, tl.constexpr adjacents) {
  /*
  Each letter in this diagram is a whole row of length dim.
  ...
  of cache_k and an xv-shaped part of cache_v
  */
  translation::unsupported_void("Translated placeholder for xformers/ops/_triton/rope_padded_kernels.py::_rope_padded_kernel");
}
