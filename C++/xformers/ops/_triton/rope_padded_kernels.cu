...
void _rope_padded_kernel(std::any xq, std::any xk, std::any xv, std::any out_q, std::any cache_k, std::any cache_v, std::any seqstartq, std::any seqstartk, std::any seqlenk, std::any theta, std::any linear_scale, int64_t use_dynamic_scaling, int64_t dynamic_old_context_len, int64_t dynamic_scale_factor, int64_t dynamic_low_freq_factor, int64_t dynamic_high_freq_factor, std::any first_seqpos, std::any seqpos, int64_t k_start, int64_t v_start, std::any n_groups, int64_t dim, std::any stride_xqM, std::any stride_xqG, std::any stride_xqH, std::any stride_xkM, std::any stride_xkG, std::any stride_xkH, std::any stride_xvM, std::any stride_xvG, std::any stride_xvH, std::any stride_cachekM, std::any stride_cachekG, std::any stride_cachekH, std::any stride_cachevM, std::any stride_cachevG, std::any stride_cachevH, std::any stride_seqstartq, std::any stride_seqstartk, std::any stride_seqlenk, std::any stride_outqM, std::any stride_outqG, std::any stride_outqH, std::any stride_seqpos, int64_t internal_dtype, int64_t const_batch_strides, std::any cache_padding_length, int64_t seqlenk_shift, int64_t BLOCK_SIZE, int64_t adjacents) {
  /*
  Each letter in this diagram is a whole row of length dim.
