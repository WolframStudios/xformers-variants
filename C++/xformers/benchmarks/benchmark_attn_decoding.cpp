...
/*
Original Python source: xformers/benchmarks/benchmark_attn_decoding.py
# Copyright (c) Facebook, Inc. and its affiliates. All rights reserved.
#
# This source code is licensed under the BSD license found in the
# LICENSE file in the root directory of this source tree.
...
class AttentionDecodingBase {
 public:
  AttentionDecodingBase() = default;
  void __init__(int64_t B, int64_t Mq, int64_t Mkv, int64_t Hq, int64_t Hkv, int64_t K, bool bw, std::any attn_bias_type) {
    translation::unsupported_void("Translated placeholder for xformers/benchmarks/benchmark_attn_decoding.py::__init__");
  }
  std::any get_inputs() {
    return translation::unsupported<std::any>("Translated placeholder for xformers/benchmarks/benchmark_attn_decoding.py::get_inputs");
  }
  void fw() {
    translation::unsupported_void("Translated placeholder for xformers/benchmarks/benchmark_attn_decoding.py::fw");
  }
};

class AttentionDecodingCUTLASS : public AttentionDecodingBase {
 public:
  AttentionDecodingCUTLASS() = default;
};

class AttentionDecodingCK : public AttentionDecodingBase {
 public:
  AttentionDecodingCK() = default;
  void __init__(int64_t B, int64_t Mq, int64_t Mkv, int64_t Hq, int64_t Hkv, int64_t K, bool bw, std::any attn_bias_type) {
    translation::unsupported_void("Translated placeholder for xformers/benchmarks/benchmark_attn_decoding.py::__init__");
  }
};

class AttentionDecodingSplitKV : public AttentionDecodingBase {
 public:
  AttentionDecodingSplitKV() = default;
};

class AttentionDecodingCKSplitKV : public AttentionDecodingBase {
 public:
  AttentionDecodingCKSplitKV() = default;
};

class AttentionDecodingSplitInt4KV : public AttentionDecodingBase {
 public:
  AttentionDecodingSplitInt4KV() = default;
  void __init__(int64_t B, int64_t Mq, int64_t Mkv, int64_t Hq, int64_t Hkv, int64_t K, bool bw, std::any attn_bias_type) {
    translation::unsupported_void("Translated placeholder for xformers/benchmarks/benchmark_attn_decoding.py::__init__");
  }
};

class AttentionDecodingPyTorchRepeat : public AttentionDecodingBase {
 public:
  AttentionDecodingPyTorchRepeat() = default;
  void fw() {
    translation::unsupported_void("Translated placeholder for xformers/benchmarks/benchmark_attn_decoding.py::fw");
  }
};

std::any get_benchmark_names() {
  return translation::unsupported<std::any>("Translated placeholder for xformers/benchmarks/benchmark_attn_decoding.py::get_benchmark_names");
}

void test_flash_attention_decoder(std::any name, std::any case) {
  translation::unsupported_void("Translated placeholder for xformers/benchmarks/benchmark_attn_decoding.py::test_flash_attention_decoder");
}
...
void main() {
  ...
  run performance benchmark
  */
  translation::unsupported_void("Translated placeholder for xformers/benchmarks/benchmark_attn_decoding.py::main");
}
