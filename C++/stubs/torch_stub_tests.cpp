...
/*
Original Python source: stubs/torch_stub_tests.py
# Copyright (c) Facebook, Inc. and its affiliates. All rights reserved.
#
# This source code is licensed under the BSD license found in the
# LICENSE file in the root directory of this source tree.
...
TEST(TorchStubTests, Sin) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_sin";
}

TEST(TorchStubTests, Unsqueeze) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_unsqueeze";
}

TEST(TorchStubTests, Unsqueeze) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_unsqueeze_";
}

TEST(TorchStubTests, Squeeze) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_squeeze_";
}

TEST(TorchStubTests, Squeeze) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_squeeze";
}

TEST(TorchStubTests, Repeat) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_repeat";
}

TEST(TorchStubTests, Multiply) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_multiply";
}

TEST(TorchStubTests, FloorDivision) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_floor_division";
}

TEST(TorchStubTests, Division) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_division";
}

TEST(TorchStubTests, Setitem) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_setitem";
}

TEST(TorchStubTests, Arange) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_arange";
}

TEST(TorchStubTests, Embedding) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_embedding";
}

TEST(TorchStubTests, InitNormal) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_init_normal";
}

TEST(TorchStubTests, View) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_view";
}

TEST(TorchStubTests, Reshape) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_reshape";
}

TEST(TorchStubTests, Transpose) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_transpose";
}

TEST(TorchStubTests, Flatten) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_flatten";
}

TEST(TorchStubTests, Empty) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_empty";
}

TEST(TorchStubTests, EmptyLike) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_empty_like";
}

TEST(TorchStubTests, Randn) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_randn";
}

TEST(TorchStubTests, All) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_all";
}

TEST(TorchStubTests, Where) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_where";
}

TEST(TorchStubTests, Getitem) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_getitem";
}

TEST(TorchStubTests, Expand) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_expand";
}

TEST(TorchStubTests, To) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_to";
}

TEST(TorchStubTests, LinearTo) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_Linear_to";
}

TEST(TorchStubTests, ModuleEval) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_Module_eval";
}

TEST(TorchStubTests, ModuleTrain) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_Module_train";
}

TEST(TorchStubTests, LinearBias) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_Linear_bias";
}

TEST(TorchStubTests, Sum) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_sum";
}

TEST(TorchStubTests, Cumsum) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_cumsum";
}

TEST(TorchStubTests, Contiguous) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_contiguous";
}

TEST(TorchStubTests, Diff) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_diff";
}

TEST(TorchStubTests, Argsort) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_argsort";
}

TEST(TorchStubTests, FunctionalPad) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_functional_pad";
}

TEST(TorchStubTests, Allclose) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_allclose";
}

TEST(TorchStubTests, NewOnes) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_new_ones";
}

TEST(TorchStubTests, OnesLike) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_ones_like";
}

TEST(TorchStubTests, SparseSoftmax) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_sparse_softmax";
}

TEST(TorchStubTests, Eye) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_eye";
}

TEST(TorchStubTests, AdaptiveAveragePool2d) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_adaptive_average_pool2d";
}

TEST(TorchStubTests, Randperm) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_randperm";
}

TEST(TorchStubTests, Sqrt) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_sqrt";
}

TEST(TorchStubTests, Multinomial) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_multinomial";
}

TEST(TorchStubTests, Bmm) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_bmm";
}

TEST(TorchStubTests, Subtract) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_subtract";
}

TEST(TorchStubTests, Add) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_add";
}

TEST(TorchStubTests, TorchFft) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_torch_fft";
}

TEST(TorchStubTests, TorchReal) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_torch_real";
}

TEST(TorchStubTests, LogicalAnd) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_logical_and";
}

TEST(TorchStubTests, And) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_and";
}

TEST(TorchStubTests, LinalgPinv) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_linalg_pinv";
}

TEST(TorchStubTests, LinalgQr) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_linalg_qr";
}

TEST(TorchStubTests, TorchMatmul) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_torch_matmul";
}

TEST(TorchStubTests, TorchOptim) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_torch_optim";
}

TEST(TorchStubTests, TorchCuda) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_torch_cuda";
}

TEST(TorchStubTests, TorchProfiler) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_torch_profiler";
}

TEST(TorchStubTests, MseLoss) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_mse_loss";
}

TEST(TorchStubTests, ClipGradNorm) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_clip_grad_norm";
}

TEST(TorchStubTests, ClipGradValue) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_clip_grad_value";
}

TEST(TorchStubTests, BitwiseNot) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_bitwise_not";
}

TEST(TorchStubTests, Cdist) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_cdist";
}

TEST(TorchStubTests, RandomManualSeed) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_random_manual_seed";
}

TEST(TorchStubTests, Clone) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_clone";
}

TEST(TorchStubTests, Equal) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_equal";
}

TEST(TorchStubTests, DiagEmbed) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_diag_embed";
}

TEST(TorchStubTests, Unbind) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_unbind";
}

TEST(TorchStubTests, Size) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_size";
}

TEST(TorchStubTests, Stack) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_stack";
}

TEST(TorchStubTests, RepeatInterleave) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_repeat_interleave";
}

TEST(TorchStubTests, Meshgrid) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_meshgrid";
}

TEST(TorchStubTests, Argmax) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_argmax";
}

TEST(TorchStubTests, Argmin) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_argmin";
}

TEST(TorchStubTests, Mean) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_mean";
}

TEST(TorchStubTests, CountNonzero) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_count_nonzero";
}

TEST(TorchStubTests, Cat) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_cat";
}

TEST(TorchStubTests, Sign) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_sign";
}

TEST(TorchStubTests, Diagonal) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_diagonal";
}

TEST(TorchStubTests, Diag) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_diag";
}

TEST(TorchStubTests, ModuleList) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_module_list";
}

TEST(TorchStubTests, SparseCooTensor) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_sparse_coo_tensor";
}

TEST(TorchStubTests, Max) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_max";
}

TEST(TorchStubTests, Einsum) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_einsum";
}

TEST(TorchStubTests, TypeAs) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_type_as";
}

TEST(TorchStubTests, Softmax) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_softmax";
}

TEST(TorchStubTests, Conv2d) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_conv2d";
}

TEST(TorchStubTests, NnParameter) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_nn_Parameter";
}

TEST(TorchStubTests, TorchDatatypes) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_torch_datatypes";
}

TEST(TorchStubTests, Norm) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_norm";
}

TEST(TorchStubTests, Rand) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_rand";
}

TEST(TorchStubTests, Randint) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_randint";
}

TEST(TorchStubTests, Zeros) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_zeros";
}

TEST(TorchStubTests, Stride) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_stride";
}

TEST(TorchStubTests, Chunk) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_chunk";
}

TEST(TorchStubTests, Abs) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_abs";
}

TEST(TorchStubTests, EnableGrad) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_enable_grad";
}

TEST(TorchStubTests, Normal) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_normal";
}

TEST(TorchStubTests, Dim) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_dim";
}

TEST(TorchStubTests, IsCuda) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_is_cuda";
}

TEST(TorchStubTests, AutogradBackward) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_autograd_backward";
}

TEST(TorchStubTests, LinalgNorm) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_linalg_norm";
}

TEST(TorchStubTests, Sized) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_Sized";
}

TEST(TorchStubTests, InitialSeed) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_initial_seed";
}

TEST(TorchStubTests, LogSoftmax) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_log_softmax";
}

TEST(TorchStubTests, MaskedSelect) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_masked_select";
}

TEST(TorchStubTests, Lt) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test__lt__";
}

TEST(TorchStubTests, Pow) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_pow";
}

TEST(TorchStubTests, Item) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_item";
}

TEST(TorchStubTests, Uniform) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_uniform_";
}

TEST(TorchStubTests, KaimingUniform) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_kaiming_uniform_";
}

TEST(TorchStubTests, Constant) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_constant_";
}

TEST(TorchStubTests, LeakyRelu) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_leaky_relu";
}

TEST(TorchStubTests, FftFft2) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_fft_fft2";
}

TEST(TorchStubTests, Real) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_real";
}

TEST(TorchStubTests, TensorInit) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_Tensor_init";
}

TEST(TorchStubTests, ReflectionPad2d) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_reflection_pad2d";
}

TEST(TorchStubTests, Half) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_half";
}

TEST(TorchStubTests, IsContiguous) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_is_contiguous";
}

TEST(TorchStubTests, Scatter) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_scatter";
}

TEST(TorchStubTests, Scatter) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_scatter_";
}

TEST(TorchStubTests, Bool) {
  GTEST_SKIP() << "Translated placeholder for stubs/torch_stub_tests.py::test_bool";
}
