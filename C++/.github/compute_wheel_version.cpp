...
/*
Original Python source: .github/compute_wheel_version.py
# Copyright (c) Facebook, Inc. and its affiliates. All rights reserved.
#
# This source code is licensed under the BSD license found in the
# LICENSE file in the root directory of this source tree.
...
std::optional<std::string> get_tagged_version() {
  /*
  Return whether we are at an exact version (namely the version variable).
  */
  return translation::unsupported<std::optional<std::string>>("Translated placeholder for .github/compute_wheel_version.py::get_tagged_version");
}

std::string get_dev_version() {
  return translation::unsupported<std::string>("Translated placeholder for .github/compute_wheel_version.py::get_dev_version");
}
