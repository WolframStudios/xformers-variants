...
/*
Original Python source: .github/selective_ci/selective_ci.py
# Copyright (c) Facebook, Inc. and its affiliates. All rights reserved.
#
# This source code is licensed under the BSD license found in the
# LICENSE file in the root directory of this source tree.
...
struct ComponentInfo {
  ...
  */
  ...
  dict[std::string, std::string] disable_set_env;
  ComponentInfo() = default;
};

std::any list_files_in_commit(git.Commit commit) {
  return translation::unsupported<std::any>("Translated placeholder for .github/selective_ci/selective_ci.py::list_files_in_commit");
}

void check_patterns_are_valid(std::any patterns) {
  translation::unsupported_void("Translated placeholder for .github/selective_ci/selective_ci.py::check_patterns_are_valid");
}
