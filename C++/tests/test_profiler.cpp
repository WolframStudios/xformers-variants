...
/*
Original Python source: tests/test_profiler.py
# Copyright (c) Facebook, Inc. and its affiliates. All rights reserved.
#
# This source code is licensed under the BSD license found in the
# LICENSE file in the root directory of this source tree.
...
TEST(Profiler, ProfilerDispatcherStreamWorkaround) {
  GTEST_SKIP() << "Translated placeholder for tests/test_profiler.py::test_profiler_dispatcher_stream_workaround";
}

TEST(Profiler, ProfilerOverhead) {
  GTEST_SKIP() << "Translated placeholder for tests/test_profiler.py::test_profiler_overhead";
}

TEST(Profiler, AnalyzeProf) {
  GTEST_SKIP() << "Translated placeholder for tests/test_profiler.py::test_analyze_prof";
}

TEST(Profiler, AttentionFlopsCausalNonsquare) {
  GTEST_SKIP() << "Translated placeholder for tests/test_profiler.py::test_attention_flops_causal_nonsquare";
}

TEST(Profiler, AnalyzeProfSdpa) {
  GTEST_SKIP() << "Translated placeholder for tests/test_profiler.py::test_analyze_prof_sdpa";
}

TEST(Profiler, AnalyzeProfMemeff) {
  GTEST_SKIP() << "Translated placeholder for tests/test_profiler.py::test_analyze_prof_memeff";
}
