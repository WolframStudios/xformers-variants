...
/*
Original Python source: tests/test_tree_attention.py
# Copyright (c) Facebook, Inc. and its affiliates. All rights reserved.
#
# This source code is licensed under the BSD license found in the
# LICENSE file in the root directory of this source tree.
...
TEST(TreeAttention, TreeAttention) {
  GTEST_SKIP() << "Translated placeholder for tests/test_tree_attention.py::test_tree_attention";
}

TEST(TreeAttention, TreeAttentionMetadataFullTree) {
  /*
  Here we test that fields tree_seq_position_ids, tree_indices, and path_lengths
  are constructed correctly; attention_bias and retrieval_indices are tested in test_tree_attention.
  */
  GTEST_SKIP() << "Translated placeholder for tests/test_tree_attention.py::test_tree_attention_metadata_full_tree";
}

TEST(TreeAttention, TreeAttentionMetadataArbitraryTree) {
  GTEST_SKIP() << "Translated placeholder for tests/test_tree_attention.py::test_tree_attention_metadata_arbitrary_tree";
}
