...
/*
Original Python source: tests/test_indexing.py
# Copyright (c) Facebook, Inc. and its affiliates. All rights reserved.
#
# This source code is licensed under the BSD license found in the
# LICENSE file in the root directory of this source tree.
...
TEST(Indexing, ScaledIndexAdd) {
  GTEST_SKIP() << "Translated placeholder for tests/test_indexing.py::test_scaled_index_add";
}

TEST(Indexing, IndexSelectCat) {
  GTEST_SKIP() << "Translated placeholder for tests/test_indexing.py::test_index_select_cat";
}
