...
/*
Original Python source: tests/test_sequence_parallel_fused_ops.py
# Copyright (c) Facebook, Inc. and its affiliates. All rights reserved.
#
# This source code is licensed under the BSD license found in the
# LICENSE file in the root directory of this source tree.
...
TEST(SequenceParallelFusedOps, SequenceParallelFused) {
  GTEST_SKIP() << "Translated placeholder for tests/test_sequence_parallel_fused_ops.py::test_sequence_parallel_fused";
}

TEST(SequenceParallelFusedOps, SequenceParallelFusedHandleAllDtypes) {
  GTEST_SKIP() << "Translated placeholder for tests/test_sequence_parallel_fused_ops.py::test_sequence_parallel_fused_handle_all_dtypes";
}
