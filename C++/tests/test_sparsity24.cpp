...
/*
Original Python source: tests/test_sparsity24.py
# Copyright (c) Facebook, Inc. and its affiliates. All rights reserved.
#
# This source code is licensed under the BSD license found in the
# LICENSE file in the root directory of this source tree.
...
TEST(Sparsity24, Sparse24LargestMask2d) {
  GTEST_SKIP() << "Translated placeholder for tests/test_sparsity24.py::test_sparse24_largest_mask_2d";
}

TEST(Sparsity24, Sparse24Causal1122) {
  GTEST_SKIP() << "Translated placeholder for tests/test_sparsity24.py::test_sparse24_causal1122";
}

TEST(Sparsity24, Sparse24LargestAbsValuesGreedy) {
  GTEST_SKIP() << "Translated placeholder for tests/test_sparsity24.py::test_sparse24_largest_abs_values_greedy";
}

TEST(Sparsity24, Sparse24LargestMask2dNotaligned) {
  GTEST_SKIP() << "Translated placeholder for tests/test_sparsity24.py::test_sparse24_largest_mask_2d_notaligned";
}

TEST(Sparsity24, Sparse24LargestMask2dBig) {
  GTEST_SKIP() << "Translated placeholder for tests/test_sparsity24.py::test_sparse24_largest_mask_2d_big";
}

TEST(Sparsity24, DetachRequiresGrad) {
  GTEST_SKIP() << "Translated placeholder for tests/test_sparsity24.py::test_detach_requires_grad";
}

TEST(Sparsity24, Detach2) {
  GTEST_SKIP() << "Translated placeholder for tests/test_sparsity24.py::test_detach2";
}

TEST(Sparsity24, MetaPackAndReorder) {
  GTEST_SKIP() << "Translated placeholder for tests/test_sparsity24.py::test_meta_pack_and_reorder";
}

TEST(Sparsity24, PackTensorAccordingToMask) {
  GTEST_SKIP() << "Translated placeholder for tests/test_sparsity24.py::test_pack_tensor_according_to_mask";
}

TEST(Sparsity24, Sp24Gemm) {
  GTEST_SKIP() << "Translated placeholder for tests/test_sparsity24.py::test_sp24_gemm";
}

TEST(Sparsity24, PackMetaShuffle) {
  GTEST_SKIP() << "Translated placeholder for tests/test_sparsity24.py::test_pack_meta_shuffle";
}

TEST(Sparsity24, PackBothWaysMetaCorrectness) {
  GTEST_SKIP() << "Translated placeholder for tests/test_sparsity24.py::test_pack_both_ways_meta_correctness";
}

TEST(Sparsity24, PackBothWaysId) {
  GTEST_SKIP() << "Translated placeholder for tests/test_sparsity24.py::test_pack_both_ways_id";
}

TEST(Sparsity24, PackBothWaysEdgeCase1) {
  GTEST_SKIP() << "Translated placeholder for tests/test_sparsity24.py::test_pack_both_ways_edge_case1";
}

TEST(Sparsity24, Sp24Apply) {
  GTEST_SKIP() << "Translated placeholder for tests/test_sparsity24.py::test_sp24_apply";
}

TEST(Sparsity24, Sp24ApiDifferentPattern) {
  GTEST_SKIP() << "Translated placeholder for tests/test_sparsity24.py::test_sp24_api_different_pattern";
}

TEST(Sparsity24, Sp24ApiDifferentPatternTransposed) {
  GTEST_SKIP() << "Translated placeholder for tests/test_sparsity24.py::test_sp24_api_different_pattern_transposed";
}

TEST(Sparsity24, Sp24TransposeInvariant) {
  GTEST_SKIP() << "Translated placeholder for tests/test_sparsity24.py::test_sp24_transpose_invariant";
}

TEST(Sparsity24, CusparseltFormat) {
  GTEST_SKIP() << "Translated placeholder for tests/test_sparsity24.py::test_cusparselt_format";
}

TEST(Sparsity24, Sp24Matmuls) {
  GTEST_SKIP() << "Translated placeholder for tests/test_sparsity24.py::test_sp24_matmuls";
}

TEST(Sparsity24, Sp24MatmulsMatVec) {
  GTEST_SKIP() << "Translated placeholder for tests/test_sparsity24.py::test_sp24_matmuls_mat_vec";
}

TEST(Sparsity24, Sp24MatmulsBmm) {
  GTEST_SKIP() << "Translated placeholder for tests/test_sparsity24.py::test_sp24_matmuls_bmm";
}

TEST(Sparsity24, Sp24ApiMlpAct24Correctness) {
  GTEST_SKIP() << "Translated placeholder for tests/test_sparsity24.py::test_sp24_api_mlp_act24_correctness";
}

TEST(Sparsity24, Sp24ApiSwigluCorrectness) {
  GTEST_SKIP() << "Translated placeholder for tests/test_sparsity24.py::test_sp24_api_swiglu_correctness";
}

TEST(Sparsity24, NotAligned) {
  GTEST_SKIP() << "Translated placeholder for tests/test_sparsity24.py::test_not_aligned";
}

TEST(Sparsity24, Sparsify24LikeDense) {
  GTEST_SKIP() << "Translated placeholder for tests/test_sparsity24.py::test_sparsify24_like_dense";
}

TEST(Sparsity24, Sparsify24Weights) {
  GTEST_SKIP() << "Translated placeholder for tests/test_sparsity24.py::test_sparsify24_weights";
}

TEST(Sparsity24, Linearw24) {
  GTEST_SKIP() << "Translated placeholder for tests/test_sparsity24.py::test_linearw24";
}

TEST(Sparsity24, WrongAlignmentErrorMessage) {
  GTEST_SKIP() << "Translated placeholder for tests/test_sparsity24.py::test_wrong_alignment_error_message";
}

TEST(Sparsity24, MinAlignment) {
  GTEST_SKIP() << "Translated placeholder for tests/test_sparsity24.py::test_min_alignment";
}

TEST(Sparsity24, WrongDtypeErrorMessage) {
  GTEST_SKIP() << "Translated placeholder for tests/test_sparsity24.py::test_wrong_dtype_error_message";
}

TEST(Sparsity24, LinearDispatchInferenceMode) {
  GTEST_SKIP() << "Translated placeholder for tests/test_sparsity24.py::test_linear_dispatch_inference_mode";
}

TEST(Sparsity24, Sp24Meta) {
  GTEST_SKIP() << "Translated placeholder for tests/test_sparsity24.py::test_sp24_meta";
}

TEST(Sparsity24, Sp24Compile) {
  GTEST_SKIP() << "Translated placeholder for tests/test_sparsity24.py::test_sp24_compile";
}

TEST(Sparsity24, Linearw24BlockCompile) {
  GTEST_SKIP() << "Translated placeholder for tests/test_sparsity24.py::test_linearw24_block_compile";
}

TEST(Sparsity24, Sp24Ste) {
  GTEST_SKIP() << "Translated placeholder for tests/test_sparsity24.py::test_sp24_ste";
}

TEST(Sparsity24, Sparsify24Ste) {
  GTEST_SKIP() << "Translated placeholder for tests/test_sparsity24.py::test_sparsify24_ste";
}

TEST(Sparsity24, CompileUnflatten) {
  GTEST_SKIP() << "Translated placeholder for tests/test_sparsity24.py::test_compile_unflatten";
}

TEST(Sparsity24, SparseNMDense) {
  GTEST_SKIP() << "Translated placeholder for tests/test_sparsity24.py::test_sparseNM_dense";
}

TEST(Sparsity24, Sparse24Fp8Sm90CutlassGemmEye) {
  GTEST_SKIP() << "Translated placeholder for tests/test_sparsity24.py::test_sparse24_fp8_sm90_cutlass_gemm_eye";
}

TEST(Sparsity24, Sparse24Fp8Sm90CutlassGemmRandomTensor) {
  GTEST_SKIP() << "Translated placeholder for tests/test_sparsity24.py::test_sparse24_fp8_sm90_cutlass_gemm_random_tensor";
}
