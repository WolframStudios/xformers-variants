...
/*
Original Python source: tests/test_sparse_tensors.py
# Copyright (c) Facebook, Inc. and its affiliates. All rights reserved.
#
# This source code is licensed under the BSD license found in the
# LICENSE file in the root directory of this source tree.
...
TEST(SparseTensors, MaskedMatmul) {
  GTEST_SKIP() << "Translated placeholder for tests/test_sparse_tensors.py::test_masked_matmul";
}

TEST(SparseTensors, Bmm) {
  GTEST_SKIP() << "Translated placeholder for tests/test_sparse_tensors.py::test_bmm";
}

TEST(SparseTensors, SparseSoftmax) {
  GTEST_SKIP() << "Translated placeholder for tests/test_sparse_tensors.py::test_sparse_softmax";
}

TEST(SparseTensors, Deepcopy) {
  GTEST_SKIP() << "Translated placeholder for tests/test_sparse_tensors.py::test_deepcopy";
}

TEST(SparseTensors, ModuleBuffer) {
  GTEST_SKIP() << "Translated placeholder for tests/test_sparse_tensors.py::test_module_buffer";
}
