...
/*
Original Python source: tests/test_fmha_merge_attentions.py
# Copyright (c) Facebook, Inc. and its affiliates. All rights reserved.
#
# This source code is licensed under the BSD license found in the
# LICENSE file in the root directory of this source tree.
...
TEST(FmhaMergeAttentions, MergeAttentionsNobias) {
  /*
  Merging the same attention twice shouldn't change anything.
  This also tests the shape of the lse output of each permitted op.
  */
  GTEST_SKIP() << "Translated placeholder for tests/test_fmha_merge_attentions.py::test_merge_attentions_nobias";
}

TEST(FmhaMergeAttentions, PartialPaged) {
  GTEST_SKIP() << "Translated placeholder for tests/test_fmha_merge_attentions.py::test_partial_paged";
}

TEST(FmhaMergeAttentions, MergeAttentionsDecoding) {
  /*
  Compute decoding attention on chunks of K/V and merge them together.
  Compare with computing attention on the whole K/V.
  */
  GTEST_SKIP() << "Translated placeholder for tests/test_fmha_merge_attentions.py::test_merge_attentions_decoding";
}

TEST(FmhaMergeAttentions, MergeAttentionsSharedinput) {
  /*
  Compute decoding attention on chunks of K/V and merge them together.
  Compare with computing attention on the whole K/V.
  */
  GTEST_SKIP() << "Translated placeholder for tests/test_fmha_merge_attentions.py::test_merge_attentions_sharedinput";
}

TEST(FmhaMergeAttentions, MergeAttentionsAgainstRef) {
  GTEST_SKIP() << "Translated placeholder for tests/test_fmha_merge_attentions.py::test_merge_attentions_against_ref";
}

TEST(FmhaMergeAttentions, MergeAttentionWithCompile) {
  GTEST_SKIP() << "Translated placeholder for tests/test_fmha_merge_attentions.py::test_merge_attention_with_compile";
}

TEST(FmhaMergeAttentions, MergeTraining) {
  GTEST_SKIP() << "Translated placeholder for tests/test_fmha_merge_attentions.py::test_merge_training";
}

TEST(FmhaMergeAttentions, MergeTrainingCompile) {
  GTEST_SKIP() << "Translated placeholder for tests/test_fmha_merge_attentions.py::test_merge_training_compile";
}

TEST(FmhaMergeAttentions, MergeTrainingZilch) {
  GTEST_SKIP() << "Translated placeholder for tests/test_fmha_merge_attentions.py::test_merge_training_zilch";
}

TEST(FmhaMergeAttentions, MergeTrainingUndilate) {
  GTEST_SKIP() << "Translated placeholder for tests/test_fmha_merge_attentions.py::test_merge_training_undilate";
}
