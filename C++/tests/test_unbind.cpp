...
/*
Original Python source: tests/test_unbind.py
# Copyright (c) Facebook, Inc. and its affiliates. All rights reserved.
#
# This source code is licensed under the BSD license found in the
# LICENSE file in the root directory of this source tree.
...
TEST(Unbind, Unbind) {
  GTEST_SKIP() << "Translated placeholder for tests/test_unbind.py::test_unbind";
}

TEST(Unbind, UnbindGetStackStrides) {
  GTEST_SKIP() << "Translated placeholder for tests/test_unbind.py::test_unbind_get_stack_strides";
}
