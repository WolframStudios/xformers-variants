...
/*
Original Python source: tests/test_fwbw_overlap.py
# Copyright (c) Facebook, Inc. and its affiliates. All rights reserved.
#
# This source code is licensed under the BSD license found in the
# LICENSE file in the root directory of this source tree.
...
TEST(FwbwOverlap, FwbwOverlap) {
  GTEST_SKIP() << "Translated placeholder for tests/test_fwbw_overlap.py::test_fwbw_overlap";
}

TEST(FwbwOverlap, FwbwNothingToOverlap) {
  GTEST_SKIP() << "Translated placeholder for tests/test_fwbw_overlap.py::test_fwbw_nothing_to_overlap";
}

TEST(FwbwOverlap, ExceptionInBwPass) {
  GTEST_SKIP() << "Translated placeholder for tests/test_fwbw_overlap.py::test_exception_in_bw_pass";
}

TEST(FwbwOverlap, ExceptionInFirstBwPass) {
  GTEST_SKIP() << "Translated placeholder for tests/test_fwbw_overlap.py::test_exception_in_first_bw_pass";
}
