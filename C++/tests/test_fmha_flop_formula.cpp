...
/*
Original Python source: tests/test_fmha_flop_formula.py
# Copyright (c) Facebook, Inc. and its affiliates. All rights reserved.
#
# This source code is licensed under the BSD license found in the
# LICENSE file in the root directory of this source tree.
...
TEST(FmhaFlopFormula, FlopFormula) {
  GTEST_SKIP() << "Translated placeholder for tests/test_fmha_flop_formula.py::test_flop_formula";
}

TEST(FmhaFlopFormula, MaskNonzeros) {
  GTEST_SKIP() << "Translated placeholder for tests/test_fmha_flop_formula.py::test_mask_nonzeros";
}
