...
/*
Original Python source: tests/test_checkpoint.py
# Copyright (c) Facebook, Inc. and its affiliates. All rights reserved.
#
# This source code is licensed under the BSD license found in the
# LICENSE file in the root directory of this source tree.
...
TEST(Checkpoint, Checkpoint) {
  GTEST_SKIP() << "Translated placeholder for tests/test_checkpoint.py::test_checkpoint";
}

TEST(Checkpoint, CheckpointWithGrad) {
  GTEST_SKIP() << "Translated placeholder for tests/test_checkpoint.py::test_checkpoint_with_grad";
}

TEST(Checkpoint, CheckpointAttention) {
  GTEST_SKIP() << "Translated placeholder for tests/test_checkpoint.py::test_checkpoint_attention";
}

TEST(Checkpoint, ListOperators) {
  GTEST_SKIP() << "Translated placeholder for tests/test_checkpoint.py::test_list_operators";
}

TEST(Checkpoint, OptimizeRuntimeWithGivenMemory) {
  GTEST_SKIP() << "Translated placeholder for tests/test_checkpoint.py::test_optimize_runtime_with_given_memory";
}

TEST(Checkpoint, OptimalCheckpointPolicy) {
  GTEST_SKIP() << "Translated placeholder for tests/test_checkpoint.py::test_optimal_checkpoint_policy";
}

TEST(Checkpoint, SelectiveCheckpointWrapperCompile) {
  GTEST_SKIP() << "Translated placeholder for tests/test_checkpoint.py::test_selective_checkpoint_wrapper_compile";
}
